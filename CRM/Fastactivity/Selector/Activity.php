 ...
 *
 */
class CRM_Fastactivity_Selector_Activity extends CRM_Core_Selector_Base implements CRM_Core_Selector_API {
  ...
  public function &getRows($action, $offset, $rowCount, $sort, $output = NULL, $case = NULL) {
    ...
    $rows = CRM_Fastactivity_BAO_Activity::getActivities($params);
