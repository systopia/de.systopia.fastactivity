 ...
 *
 */
class CRM_Fastactivity_Selector_Search extends CRM_Core_Selector_Base implements CRM_Core_Selector_API {
  ...
  public function &getRows($action, $offset, $rowCount, $sort, $output = NULL) {
    ...
    while ($result->fetch()) {
      ...
      $activityActions = new CRM_Fastactivity_Selector_Activity($result->contact_id, NULL);
