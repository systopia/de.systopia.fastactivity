 ...
 */
class CRM_Fastactivity_Upgrader_Base {

  /**
   * @var CRM_Fastactivity_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Fastactivity_Upgrader(
   ...
   *
   * ```
   * CRM_Fastactivity_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Fastactivity_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
